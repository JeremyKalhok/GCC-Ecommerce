...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    await fetch('http://localhost:4000/upload', { // mimics the backend call in the index.js file
    ...
    if(responseData.success){ // if success attribute is true, POST method was successful, and image was successfully stored using multer
      ...
      console.log(product);
      await fetch('http://localhost:4000/addproduct', { // send the new product object to the addproduct endpoint to be added to the MongoDB database
        method: 'POST',
        headers: {
          Accept: 'application/json',
